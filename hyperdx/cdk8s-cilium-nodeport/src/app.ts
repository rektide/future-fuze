...
import type { NodePortConfig } from './config.js';
...
export class App extends Chart {
  constructor(scope: Construct, id: string, props: AppProps) {
      ...
      containers: [
        {
          ...
          ports: [
            { containerPort: props.apiPort, name: 'api' },
            { containerPort: props.appPort, name: 'app' },
            { containerPort: props.opampPort, name: 'opamp' },
          ],
          env: [
    ...
    const serviceType = props.nodePort?.enabled ? kplus.ServiceType.NODE_PORT : kplus.ServiceType.LOAD_BALANCER;
    ...
    new kplus.Service(this, 'service', {
      ...
      ports: [
        { 
          name: 'api', 
          port: props.apiPort, 
          targetPort: props.apiPort,
          nodePort: props.nodePort?.enabled ? props.nodePort.apiPort : undefined,
        },
        { 
          name: 'app', 
          port: props.appPort, 
          targetPort: props.appPort,
          nodePort: props.nodePort?.enabled ? props.nodePort.appPort : undefined,
        },
